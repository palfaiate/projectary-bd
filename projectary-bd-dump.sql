...
ALTER TABLE "projectreventity"
	DROP FOREIGN KEY "projectreventity_function_fk"
GO

ALTER TABLE "projectreventity"
	DROP FOREIGN KEY "projectreventity_entity_fk"
GO
...
DROP INDEX "projectreventity_function_fk" ON projectreventity
GO

DROP INDEX "projectreventity_project_index" ON projectreventity
GO
...
DROP TABLE "projectweb"
GO

DROP TABLE "projectrevlogdoc"
GO

DROP TABLE "projectrevlog"
GO

DROP TABLE "projectreventity"
GO

DROP TABLE "projectrev"
GO
...
DROP TABLE "applicationattribute"
GO
...
CREATE PROCEDURE "LoginChallenge"  (IN `username` varchar(255), IN `password` varchar(255))
	SQL SECURITY DEFINER
	NOT DETERMINISTIC
	CONTAINS SQL
BEGIN
...
WHEN RESULT=1 THEN SELECT u.entity,e.name FROM users AS u,entity as e WHERE u.entity=e.id and u.username=username and u.password=password;
END CASE;
END
GO
...
CREATE INDEX "projectreventity_function_fk" USING BTREE 
	ON "projectreventity"("function")
GO

CREATE INDEX "projectreventity_project_index" USING BTREE 
	ON "projectreventity"("projectrev")
GO
...
ALTER TABLE "projectreventity"
	ADD CONSTRAINT "projectreventity_function_fk"
...
ALTER TABLE "projectreventity"
	ADD CONSTRAINT "projectreventity_entity_fk"
	FOREIGN KEY("entity")
	REFERENCES "entity"("id")
	ON DELETE RESTRICT 
	ON UPDATE RESTRICT 
